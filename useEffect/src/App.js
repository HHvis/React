...
import UserCardsList from "./components/Praktika2Route/UserCardsList";
...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/UserCardsList" element={<UserCardsList />} />
      <Route path="/UserCard/:name" element={<UserProfile />} />
